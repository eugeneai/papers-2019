...
\begin{document}
\title{Representation of MDA Transformation by Means of Logical Objects}
...
Transformation generated Java modules implementing structural and operational features of blocks.  The logic of some Mothur modules functioning requires to make flexible set of output connection to make usage of complex modules to be more convenient for end user. Now we are working on extending the knowledge base to generate algorithms figuring out the set of acceptable connections depending input and module configuration.
...
With this tool now we will develop a programming techniques aimed at reuse of knowledge and their specialization, thus, supporting programming traditions used in small information system developing companies and collectives.  Another aspect of research is integration with existing Linked Open Data sources such as \cite{digarch}.
...
\bibitem{Rhazali} \textbf{Y.\,Rhazali, Y.\,Hadi, I.\,Chana, M.\,Lahmer, A.\,Rhattoy.} A model
...
\bibitem{Hamid} \textbf{B.\,Hamid, D.\,Weber.} Engineering secure systems: Models, patterns
