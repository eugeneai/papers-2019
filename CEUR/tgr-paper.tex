...
\author{Evgeny Cherkashin\inst{1,2}\and
Alexey Shigarov\inst{1}\and
Viacheslav Paramonov\inst{1}\and
Ljubica Kazi\inst{3}
}
...
%Melentiev Energy Systems Institute of SB RAS, 130 Lermontov Street, Irkutsk, 664033, Russia\and
%Irkutsk State University, 20 Gagarina Avenue, Irkutsk, 664002, Russia\and
...
\section{Related work on ontology usage in MDA}
