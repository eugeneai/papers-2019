...
The presented approach supports various natural language processing, for example, declination of nouns, pronouns, participles and other words.  For this purpose, a \texttt{data-<command>} attribute HTML extension, JavaScript browser support, and a language service is implemented, where queries are sent from browser.  The attribute combinations define structural language morphological relations, which are interpreted by JavaScript routines.
