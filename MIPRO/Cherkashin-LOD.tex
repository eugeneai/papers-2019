...
Viacheslav Paramonov\IEEEauthorrefmark{1},
...
E-mail:\texttt{\{eugeneai,shigarov,slv,mikhailov\}@icc.ru}}
...
%%% End:
    ...
    Positive aspects of the paper: The proposed technological solution is innovative and relies on the newest standards and technologies in knowledge representation and automated reasoning.

    Objections to the paper:
    Issues that should be addressed are numbered:

    3. The Authors rely their system on a number of third-party technologies. Especially, ClioPatria system and Pengines protocol seem to be important. The Authors do not discuss what are the benefits or the downsides of relying their system on the projects that are also currently under construction.

    Just a comment: The Authors actually present very little information about what one can realistically expect from such a developed system. Obviously, the developed services have much potential, but they are not coherently organized in a single web application, they are rather a toolkit intended for various needs. This lack of completion is a negative aspect of the work that, unfortunately, cannot be currently corrected. The Authors should strive to work on a more complete version of the system for further publications.

    Technical Quality: Good
    Originality: Good
    Presentation style: Adequate
    Relevance to the conference: Good
    Reviewers' opinion: Recommended for acceptance after implementing recommended suggestions and corrections
